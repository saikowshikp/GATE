...
\end{cases}
\end{align}
Probability distribution function of Y is
\begin{align}
f_Y(y)&=\sum p_Y(y_i)\delta (y-y_i)
\end{align}
Let,
\begin{align}
p_Y(y_i)&=
...
\end{cases}
\end{align}
$g(y)$ be the component of pdf of Y for x $\in$ (-2,-1) $\cup$ (1,2)
\begin{align}
f_Y(y)&=p_Y(-1)\delta(y+1) + p_Y(0)\delta(y) + p_Y(1)\delta(y-1) + g(y)\\
